...
# ------ Load data from file -----
data = pd.read_csv('../data/owneva.csv')
print (data.keys())

data = data.fillna(0)

# input: (attibute traits, attributes preference) in pairs
x = data[['gender', 'gender2', 'attr3_1', 'sinc3_1',
       'fun3_1', 'intel3_1', 'amb3_1', 'attr1_1', 'sinc1_1', 'intel1_1',
       'fun1_1', 'shar1_1', 'attr3_1.1', 'sinc3_1.1', 'fun3_1.1', 'intel3_1.1',
       'amb3_1.1', 'pf_o_att', 'pf_o_sin', 'pf_o_int', 'pf_o_fun', 'pf_o_amb',
       'pf_o_sha']]
print(x)
...
checkpoint_name = 'M1-own-Weights-{epoch:03d}--{val_loss:.5f}.hdf5' 
